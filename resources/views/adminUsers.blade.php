	...
	<div class="row justify-content-center">
		<div class="col-md-6 col-xs-10">
          ...
          <script type="text/javascript">
			...
			{{-- <p> ABC </p> --}}
			<div class="card">
                <div class="card-header" style="background-color: #3490DC; color:white;"><h4>{{ __('Users Registered') }}</h4></div>
							...
							@foreach($users as $users)
								...
								<tr>
									...
									<td class="text-center" >
										{!!Form::open(['action' => ['App\Http\Controllers\AdminViewUsers@destroy', $users->id], 'method' => 'POST', 'class' => 'pull-right'])!!}
