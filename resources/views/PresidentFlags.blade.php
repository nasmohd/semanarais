	...
	<div class="row justify-content-center">
		<div class="col-md-10 col-xs-10">
          ...
          <div class="float-right ml-auto">
          	<a href="/Presidenthome" class="btn btn-link"><i class="fas fa-external-link-alt"></i> View complaints </a>
          ...
          <script type="text/javascript">
			...
			<div class="card mt-lg-2">
                <div class="card-header pt-lg-4" style="background-color: #E74A3B; color:white;"><h4><i class="fas fa-envelope mr-2"></i>{{ __('Complaints Flagged') }}</h4></div>
							...
							@foreach($complaints as $complaint)
								<tr>
									...
									<td class="text-center">
										{!! Form::open (['action' => ['App\Http\Controllers\PresidentFlaggedComplaints@update', $complaint-> id, $complaint -> ministry], 'id' => 'EditForm_submit']) !!}
										<button type='submit' class="btn btn-sm btn-info" data-toggle="tooltip" title="Flag this record">
											<span style="font-size:13px; color:white"><i class="fas fa-pencil-alt"></i> </span>
										</button>
