    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled " style="font-size:13px;">
                <li class=""> <!-- action -->
                    <a href="/Ministryhome" aria-expanded="false"><i class="fas fa-tachometer-slowest mr-2"></i>Dashboard</a>
                ...
                <li>
                    <a href="/MinistrySolved" aria-expanded="false"><i class="fas fa-envelope mr-1"></i> View Complaints</a>
    ...
    <div id="app">
        <nav class="navbar navbar-dark navbar-expand-md shadow-sm" style="background-color: #306Fa0; color:white;">
            <div class="container">
                ...
                <a class="navbar-brand" href="{{ url('/Ministryhome') }}" style="color:white;">
                    {{ _('SEMA NA RAIS') }}
                </a>
