...
<body>
    ...
    <div id="app">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre style="color:white;">
                                 <span class = "pl-1 mr-1" style ="border-radius: 50%; background-color:#38C172;">&#10003; </span>   {{ Auth::user()->name }}
                                </a>
        ...
        <main class="py-4" id="dismissClick">
            @yield('content')
        </main>
...
<style type="text/css">
    ...
    #app{
        ...
        <div class="mt-2 text-center dismissClick" style="background-color: #306FA0; color: white;" id="footr">
