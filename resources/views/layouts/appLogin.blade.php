    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled " style="font-size:13px;">
                <li class="active">
                    <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false"><i class="fas fa-tachometer-slowest mr-2"></i>Dashboard</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre style="color:white;"><span class = "pl-1 mr-1" style ="border-radius: 50%; background-color:#38C172;">&#10003; </span> 
                                    {{ Auth::user()->name }}
                                </a>
