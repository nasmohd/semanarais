    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled " style="font-size:13px;">
                <li class="">
                    <a href="/Presidenthome" aria-expanded="false"><i class="fas fa-tachometer-slowest mr-1"></i>Dashboard</a>
                ...
                <li class="">
                    <a href="/PresidentMinistryInfo" aria-expanded="false"><i class="fas fa-tachometer-slowest mr-1"></i>Ministry info</a>
                    {{-- <ul class="collapse list-unstyled" id="homeSubmenu">
                        <li>
                            <a href="#">Home 1</a>
                        </li>
                ...
                {{-- <li>
                    <a href="/settings" aria-expanded="false"><i class="fas fa-cog mr-1"></i>Settings</a>
    ...
    <div id="app">
        <nav class="navbar navbar-dark navbar-expand-md shadow-sm" style="background-color: #306Fa0; color:white;">
            <div class="container">
                ...
                <a class="navbar-brand" href="{{ url('/Presidenthome') }}" style="color:white;">
                    {{ _('SEMA NA RAIS') }}
                </a>
