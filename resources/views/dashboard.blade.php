	...
	<div class="row justify-content-center">
		<div class="col-md-10 col-xs-10">
          ...
          <script type="text/javascript">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header" style="background-color: #306FA0; color:white;">
							<h4 class="modal-title ml-4"><i class="fas fa-envelope mr-2"></i>New Complaint</h4>
							...
							{{-- <form role="form"> --}}
								<div class="card-body">
									...
									<div class="form-group">
										...
										@endif
										@if(count($complaints['ministries']) == 0)
											<option selected disabled> <i class="fas fa-exclamation-circle"></i>No Ministries yet! </option>
			...
			{{-- <p> ABC </p> --}}
			<div class="card">
                <div class="card-header pt-3" style="background-color: #3490DC; color:white;"><h5><i class="fas fa-envelope mr-2"></i>{{ __('Complaints') }}</h5></div>
					...
					<table class="table table-responsive table-hover table-striped">
						<thead>
							<tr> <!-- Table Headings -->
								...
								<th scope="col" style="width:17%">Contents</th>
								<th scope="col" style="width:30%">Ministry Concerned</th>
							...
							@foreach($complaints['complaints'] as $complaint)
								<tr>
									...
									<td >
										...
										<div class="col">
										<div class="row">
											<a href="/complaint/{{ $complaint-> id}}/edit" type="button" class="btn btn-sm btn-secondary mr-2"  data-toggle="tooltip" title="Edit this record"> <i class="fas fa-pencil-alt"></i> </a>

											{!!Form::open(['action' => ['App\Http\Controllers\ComplaintsController@destroy', $complaint->id], 'method' => 'POST', 'class' => 'pull-right'])!!}
											{{Form::hidden('_method', 'DELETE')}}
												
											<button type="submit" class="btn btn-sm btn-danger btn-circle" data-toggle="tooltip" title="Delete this record"> <i class="fas fa-trash"></i> </button>
									...
									<td >
										<a href="/complaint/{{ $complaint-> id}}/Viewrecord" type="button" class="btn btn-sm btn-secondary mr-2"  data-toggle="tooltip" title="More info about this record"> info </a>

										{{-- <a href="/" class="btn-sm btn-secondary float-right" data-toggle="tooltip" title="View all info for this record"> info </a> --}}
									</td>
								</tr>
						...
						@if(count($complaints['complaints']) == 0)
							<div class="alert alert-danger"><i class="fas fa-exclamation-circle"></i> You have not submitted any complaints</div>
