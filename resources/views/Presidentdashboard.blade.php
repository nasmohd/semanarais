	...
	<div class="row justify-content-center">
		<div class="col-md-10 col-xs-10">
          ...
          <div class="float-right ml-auto">
          	<a href="/PresidentFlags" class="btn btn-link"><i class="fas fa-external-link-alt"></i> View Flagged complaints </a>
							...
							@foreach($complaints as $complaint)
								<tr>
									...
									<td class="text-center">
										{!! Form::open (['action' => ['App\Http\Controllers\PresidentComplaints@update', $complaint-> id, $complaint -> ministry], 'id' => 'EditForm_submit']) !!}
