	...
	<div class="row justify-content-center">
		<div class="col-md-10 col-xs-10">
          ...
          <div class="float-right ml-auto">
          	<a href="/Ministryhome" class="btn btn-link"><i class="fas fa-external-link-alt"></i> View unprocessed complaints </a>
          ...
          <script type="text/javascript">
			...
			<div class="card mt-lg-2">
                <div class="card-header pt-lg-4" style="background-color: #1CC88A; color:white;"><h4><i class="fas fa-envelope mr-2"></i>{{ __('Processed Complaints') }}</h4></div>
