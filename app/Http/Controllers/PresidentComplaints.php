...
class PresidentComplaints extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $query = "select * from complaints where flagDate < '".$now."' and status = 0 and PresidentFlag != '1' ";
        $complaints = DB::select($query, [true]);
