...
class MinistryComplaints extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $query = "select * from complaints where ministry = '".$name."' and status = '0'";
        ...
        // print_r($complaints);
        // return view ('dashboard')->with('complaints', $complaints);
        return view ('Ministrydashboard')->with('complaints', $complaints);
    }
